	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"><strong>Data Jurusan</strong></h3>
			</div>
				...
				<div class="col-md-8">
					<table width="100%" class="table table-striped table-bordered">
						<tr>
							...
							<td width="70%">
							<a href="<?php echo site_url('printer/cetak_jurusan');?>" target="_blank" class="btn btn-warning btn-sm">Print Data</a></td>
						</tr>
						<tr>
				...
				<div class="col-md-4">
					<div class="panel panel-info">
						<div class="panel-body bg-info">
							<span class="pull-left"><i class="fa fa-briefcase fa-3x"></i></span>
							<span class="pull-right"><div class="huge-2x text-right"><?php echo $hitung; ?></div> Data Jurusan</span>
						</div>
					</div>
				</div>
			</div>
						    	...
						    	<div class="modal-content">
						    		<div class="modal-header modal-header-primary">
						      		...
						      		<div class="modal-body">
								        <form action="<?php echo site_url('data_jurusan/tambah_data');?>" enctype="multipart/form-data" method="post">
							            	
							            	<div class="form-group">
												<h6 for="nama">Nama Jurusan:</h6>
												<input type="text" class="form-control input-sm" name="nama_jurusan" placeholder="Nama Jurusan">
											</div>
											<div class="form-group">
...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-success">
		  ...
		  <div class="panel-body">
		  			<form action="<?php echo site_url('data_jurusan/hapus_data_all'); ?>" method="post" enctype="multipart/form-data" >
		   			...
		   			<table id="table" class="table table-striped table-bordered">
						...
						<tbody>
						<?php $nomer=1; foreach ($data_jurusan as $baris) { ;?>
							<tr>
								<td><input type="checkbox" name="msg[]" value="<?php echo $baris->id_jurusan; ?>"></td>
							...
							<div class="modal fade" id="edit<?php echo $nomer; ?>" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
								<div class="modal-dialog">
							    	<div class="modal-content">
							    		<div class="modal-header modal-header-primary">
									        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
									        <h4 class="modal-title" id="myModalLabel">Edit data dari <code class="text-success"><?php echo $baris->nama_jurusan; ?></code></h4>
							      		</div>
							      		<div class="modal-body">
									        <form action="<?php echo site_url('data_jurusan/edit_data');?>" enctype="multipart/form-data" method="post">
								            	<input type="hidden" class="form-control" name="id_jurusan" value="<?php echo $baris->id_jurusan; ?>">
								            	<div class="form-group">
													<h6 for="nama">Nama Jurusan:</h6>
													<input type="text" class="form-control input-sm" name="nama_jurusan" value="<?php echo $baris->nama_jurusan;?>">
												</div>
												<div class="form-group">
													<h6 for="nama">Keterangan Jurusan:</h6>
												<textarea type="text" class="form-control input-sm" name="keterangan"><?php echo $baris->keterangan;?></textarea>												</div>
								...
								<div class="modal-dialog">
							    	<div class="modal-content">
							    		<div class="modal-header modal-header-danger">
							      		...
							      		<div class="modal-body">
									        <form action="<?php echo site_url('data_jurusan/hapus_data');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
								            	<input type="hidden" class="form-control" name="id_jurusan" value="<?php echo $baris->id_jurusan; ?>">
								                   	<p>Apakah anda yakin akan menghapus data dari: <code class="text-danger"><?php echo $baris->nama_jurusan; ?></code> ?</p>
									        	<div class="modal-footer">
									                <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
									                <button type="submit" class="btn btn-danger">Hapus</button>
									         	</div>

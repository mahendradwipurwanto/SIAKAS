...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="well well-small well-box">
        	<a href="<?php echo base_url()?>data_kelas">
	            <center>
	           		<i class="fa fa-id-badge fa-5x"></i>
	            </center>
        	</a>
	        <center>
		        <h5><b><?php echo $hitung_kelas; ?> <span class="text-semibold">Data Kelas</span></b></h5>
	       	</center>
        </div>
    </div>
    <div class="col-md-3">
        <div class="well well-small well-box">
        	<a href="<?php echo base_url()?>data_jurusan">
	            <center>
	           		<i class="fa fa-briefcase fa-5x"></i>
	            </center>
        	</a>
	        <center>
		        <h5><b><?php echo $hitung_jurusan; ?> <span class="text-semibold">Data Jurusan</span></b></h5>
	       	</center>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-md-6">
        <div class="well well-small well-box">
            <b><i class="fa fa-sign-out"></i> Riwayat login pengguna</b>
            <table class="table table-striped table-condensed">
                <tbody>
                    <?php foreach ($login_history as $row) {?>
                    <tr>
                        <td><span><a href=""  style="text-decoration:none"><?php echo $row->username;?></span></a><span class="text-muted pull-right"><?php echo $row->login_time;?></span></td>
                    </tr>
                    <?php }?>
                </tbody>
            </table>
        ...
        <div class="well well-small well-box">
            ...
            <table class="table table-striped table-condensed">
                <tbody>
                    ...
                    <tr>
                        <td><span><a href="<?php echo base_url();?>dashboard/tentang_admin/<?php echo $row2->id_update;?>"  style="text-decoration:none">Update versi <?php echo $row2->update_versi;?></span></a></td>
                    </tr>
                    <?php }?>
                </tbody>
            </table>

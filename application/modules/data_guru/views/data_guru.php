					...
					<table width="100%" class="table table-striped table-bordered">
						<tr>
							...
							<td width="70%"> 
								...
								<a href="<?php echo site_url('printer/cetak_guru');?>" target="_blank" class="btn btn-warning btn-sm">Print Data</a>
								<a href="<?php echo site_url('data_guru/export');?>" target="_blank" class="btn btn-success btn-sm">Export Data <b>EXCEL</b></a></td>
						</tr>
						<tr>

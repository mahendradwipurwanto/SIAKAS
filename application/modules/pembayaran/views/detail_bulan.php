	...
	<div class="col-md-12">
        <div class="well well-small well-box">
            <?php foreach ($data_bulanan as $data) { ;?>
                <b><i class="fa fa-file"></i> Daftar Beban Bulanan</b> <a href="<?php echo site_url('pembayaran/info_administrasi')?>" class="btn btn-default btn-sm pull-right"><i class="fa fa-arrow-left"></i> Back</a>
                <hr>

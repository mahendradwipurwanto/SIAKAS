	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"><strong>Data POS pembayaran</strong></h3>
			</div>
				...
				<div class="col-md-4">
					<div class="panel panel-info">
						<div class="panel-body bg-info">
							...
							<span class="pull-right"><div class="huge-2x text-right"><?php echo $hitung; ?></div> Data POS pembayaran</span>
						</div>
					</div>
				</div>
			</div>
			    	...
			    	<div class="modal-content">
			    		<div class="modal-header modal-header-primary">
			      		...
			      		<div class="modal-body">
					        <form action="<?php echo site_url('pos_pembayaran/tambah_data');?>" enctype="multipart/form-data" method="post">
...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-success">
		  ...
		  <div class="panel-body">
		  			<form action="<?php echo site_url('pos_pembayaran/hapus_data_all'); ?>" method="post" enctype="multipart/form-data" >
		   			...
		   			<table id="table-scroll" class="table table-striped table-bordered" width="100%">
						...
						<tbody>
						<?php $nomer=1; foreach ($pos_pembayaran as $baris) { ;?>
							<tr>
								...
								<div class="modal-dialog">
							    	<div class="modal-content">
							    		<div class="modal-header modal-header-primary">
							      		...
							      		<div class="modal-body">
									        <form action="<?php echo site_url('pos_pembayaran/edit_data');?>" enctype="multipart/form-data" method="post">
								...
								<div class="modal-dialog">
							    	<div class="modal-content">
							    		<div class="modal-header modal-header-danger">
							      		...
							      		<div class="modal-body">
									        <form action="<?php echo site_url('pos_pembayaran/hapus_data');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
								            	<input type="hidden" class="form-control" name="id_pos" value="<?php echo $baris->id_pos; ?>">

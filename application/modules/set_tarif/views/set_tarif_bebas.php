		...
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<?php foreach ($data_jenispembayaran as $rows2) { ;?>
					<b class="text-danger"><?php echo $rows2->nama_pembayaran; ?></b> | <strong class="label label-primary">BEBAS</strong>
				</h3>
			</div>
				...
				<div class="col-md-4">
					<div class="panel panel-info">
						<div class="panel-body bg-info">
							...
							<span class="pull-right"><div class="huge-2x text-right"><?php echo $jumlah_pembayar_bebas; ?></div> Jumlah Pembayar</span>
						</div>
					</div>
				</div>
			</div>

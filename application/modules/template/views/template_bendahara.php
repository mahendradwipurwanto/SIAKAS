        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="<?php echo site_url('setting/list_pengumuman')?>"><b class="upper"><i class="fa fa-bullhorn fa-lg"></i> <span class="badge"><?php echo $pengumuman;?></span></b></a></li>
            ...
            <div class="row">
                <div class="col-md-3">
                    <nav class="navbar navbar-default-side">
                        <div class="sidebar">
                          <ul class="widget widget-menu">
                            ...
                            <li><a href="<?php echo base_url(); ?>data_guru"> Data Guru <i class="fa fa-user fa-lg pull-right"></i></a></li>
                            <li><a href="<?php echo base_url(); ?>data_siswa"> Data Siswa <i class="fa fa-users fa-lg pull-right"></i></a></li>
                    ...
                    <nav class="navbar navbar-default-side">
                        <div class="sidebar">
                          <ul class="widget widget-menu">
                            <li><a href="#" data-toggle="modal" data-target="#logout"> Logout <i class="fa fa-power-off fa-lg pull-right"></i></a></li>
                          </ul>
                        </div>
                    </nav>
                </div>

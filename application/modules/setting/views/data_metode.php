<div class="row">
	<div class="col-md-12">
		<ol class="breadcrumb alert alert-white" role="alert">
			...
			<li class="active">Data Metode</li>
		</ol>
	</div>
</div>
		<div class="row">
			<div class="col-md-12">
		        <div class="well well-small well-box">
					...
					<table id="table" class="table table-striped table-bordered">
						...
						<tbody>
						<?php $nomer=1; foreach ($data_metode as $baris) { ;?>
							<tr>
								<td><?php echo $nomer ;?></td>
								<td><?php echo $baris->nama_metode ;?></td>
								...
								<div class="modal-dialog">
							    	<div class="modal-content">
							    		<div class="modal-header modal-header-primary">
									        ...
									        <h4 class="modal-title" id="myModalLabel">Edit data dari <code class="text-success"><?php echo $baris->nama_metode; ?></code></h4>
							      		</div>
							      		<div class="modal-body">
									        <form action="<?php echo site_url('setting/update_metode');?>" enctype="multipart/form-data" method="post">
								            	<input type="hidden" class="form-control" name="id_metode" value="<?php echo $baris->id_metode; ?>">
								            	<div class="form-group">
													<h6 for="nama">Nama Metode:</h6>
													<input type="text" class="form-control input-sm" name="nama_metode" value="<?php echo $baris->nama_metode?>">
												</div>
								            	<div class="form-group">
								...
								<div class="modal-dialog">
							    	<div class="modal-content">
							    		<div class="modal-header modal-header-danger">
							      		...
							      		<div class="modal-body">
									        <form action="<?php echo site_url('setting/hapus_metode');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
								            	<input type="hidden" class="form-control" name="id_metode" value="<?php echo $baris->id_metode; ?>">
								                   	<p>Apakah anda yakin akan menghapus data dari: <code class="text-danger"><?php echo $baris->nama_metode; ?></code> ?</p>
									        	<div class="modal-footer">
								...
								<div class="modal-dialog">
							    	<div class="modal-content">
							    		<div class="modal-header modal-header-primary">
							      		...
							      		<div class="modal-body">
									        <form action="<?php echo site_url('setting/tambah_metode');?>" enctype="multipart/form-data" method="post">
								            	<div class="form-group">
													<h6 for="nama">Nama Metode:</h6>
													<input type="text" class="form-control input-sm" name="nama_metode" placeholder="metode">
												</div>
								            	<div class="form-group">
													<h6 for="nama">Keterangan:</h6>
